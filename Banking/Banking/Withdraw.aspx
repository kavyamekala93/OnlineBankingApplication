<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Withdraw.aspx.cs" Inherits="Banking.Withdraw" %>
...
<style type="text/css">
   ...
   <tr><td><h2 class="style2"><asp:Label ID="LblNames" runat="server" style="text-align: center; margin-left: 200px; ForeColor=Black" 
        Text="WITHDRAW" ForeColor="Black"></asp:Label></h2></td></tr>
